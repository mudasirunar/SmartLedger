...
class GenericAddEditActivity : AppCompatActivity() {
    ...
    private lateinit var thumbnailAdapter: com.mudasir.smartledger.adapter.ThumbnailAdapter
    ...
    private fun setupPhotoLogic() {
        ...
        thumbnailAdapter = com.mudasir.smartledger.adapter.ThumbnailAdapter(selectedImagePaths) { imagePath ->
