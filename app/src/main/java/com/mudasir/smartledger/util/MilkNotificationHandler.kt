...
class MilkMorningWorker(val context: Context, workerParams: WorkerParameters) : CoroutineWorker(context, workerParams) {
    ...
    private fun showMilkInputNotification(context: Context, activeMonth: com.mudasir.smartledger.data.MilkRecord) {
        val contentIntent = Intent(context, com.mudasir.smartledger.activity.ViewMilkActivity::class.java).apply {
