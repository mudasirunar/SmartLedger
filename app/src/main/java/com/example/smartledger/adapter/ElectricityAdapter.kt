...
class ElectricityAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { if (isSelectionMode) toggleSelection(position) else onNormalClick(item) }
        holder.itemView.setOnLongClickListener { if (!isSelectionMode) { onLongClick(); startSelectionMode(position) }; true }
    }
